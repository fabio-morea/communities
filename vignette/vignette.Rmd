...
```{r}
sol_space <- communities::solutions_space(g, tmax = 100, met = "LV", confidence = 0.95,  comp_method = "ami")
M <- sol_space$M 
df <- sol_space$data
sm <- sol_space$simil
...
g <- communities::make_ring_of_cliques(num_cliques = 4,
                                       ...
                                       add_center = T, 
                                       add_bridges = F)
ssp <- communities::solutions_space(g, tmax = 100, met = "LP", resolution = 1, confidence = .95) 
ssp$data
#ssp$M
plot_sol_space(ssp)
```
...
random_ssp <- communities::solutions_space(random_graph, tmax = 10, met = "LV", 
